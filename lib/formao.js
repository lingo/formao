...
var prerenderFormField = function(field) {
    ...
    var typeOptions = [
        ...
        dbField._typeName,
        dbField.type ? dbField.type.toString() : undefined,
        dbField.type,
        dbField.toString()
    ];
    // Find a valid type!
 ...
 *     var form = new reFormed.Formao(database.model('Project'))
 *     form.
 *         .method('POST')
 *         .action('/project/add')
 ...
 * @param {Obhect} options Additional Formao options (see Options)
 * @param {Instance} instance Optional model instance to use for filling form data
 */
function Formao(model /*, options, instance */) {
    this._options      = {
    ...
    this._perItemAppend       = [];
    this._labels              = {};
    // Set label for submit input using 'magic' constant.
    this._labels[Formao.SUBMIT] = 'Submit';
 ...
 */
Formao.prototype.data = function() {
 ...
 */
Formao.prototype.fill = function(instanceData) {
 ...
 */
Formao.prototype.method = function(method) {
 ...
 * @return {mixed}  Formao or String
 */
Formao.prototype.action = function(url) {
    if (arguments.length === 0) {
        return this._action;
    }
    this._action = url;
 ...
 */
Formao.prototype.attr = function(attributeMap) {
    if (arguments.length === 0) {
        return this._attr;
    }
 ...
 * @return {Formao} self-reference for chaining
 */
Formao.prototype.addAttribute = function(key, value) {
 ...
 * @return {Formao} self-reference for chaining
 */
Formao.prototype.addClass = function(classes) {
 ...
 * @return {Formao} self-reference for chaining
 */
Formao.prototype.label = function(key, value) {
 ...
 * @return {mixed} Formao or Object
 */
Formao.prototype.labels = function(labelMap) {
    if (arguments.length === 0) {
        return this._labels;
    }
 ...
 * @return {Formao}              self-reference for chaining
 */
Formao.prototype.appendTemplate = function(templateName, data) {
    this._append.push({
 ...
 * @return {Formao}      self-reference for chaining
 */
Formao.prototype.appendHTML = function(html) {
    this._append.push({
        template: null,
        html:     html
    });
 ...
 */
Formao.prototype.fields = function() {
    return this._fields;
};
 ...
 */
Formao.prototype.prerender = function(req) {
    var self = this;
 ...
 */
Formao.prototype.render = function(app /*, req */) {
    var self          = this;
 ...
 * @type {String}
 */
Formao.SUBMIT = '__formao__submit__label__';

// module.exports.validationClasses = buildValidationClasses;

module.exports.Formao            = Formao;
